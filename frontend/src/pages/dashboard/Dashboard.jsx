    ...
    <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-slate-50 mt-2">
                  {formatCurrencyINR(kpis.totalBudget)}
                </p>
              </div>
              <div className="p-3 bg-blue-500/10 rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          ...
          <p className="text-2xl font-bold text-amber-500 mt-2">{formatCurrencyINR(analytics.totalVendorSpend)}</p>
        </Card>
        <Card>
          <p className="text-slate-400 text-sm">Attendance Labor Cost</p>
          <p className="text-2xl font-bold text-emerald-500 mt-2">{formatCurrencyINR(analytics.attendanceLaborCost)}</p>
        </Card>
      </div>
